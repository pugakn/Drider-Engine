...
#   define DR_ENGINE_EXPORT
# else
#	if defined(ENGINE_EXPORTS)
#   define DR_ENGINE_EXPORT __declspec( dllexport )
#   else
#     if defined( __MINGW32__ )
#       define DR_ENGINE_EXPORT              //Linux systems don't need this
#     else
#       define DR_ENGINE_EXPORT __declspec( dllimport )
#     endif
#   endif
# endif
#endif
...
#   define DR_ENGINE_EXPORT  __attribute__ ((visibility("default")))
# else
#   define DR_ENGINE_EXPORT
# endif
