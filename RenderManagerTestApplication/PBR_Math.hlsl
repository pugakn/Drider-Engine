...
float3 PeturbNormal(float3 localNormal,
...
float3
Fresnel_Shlick(in float3 f0, in float3 f90, in float x) {
...
float
Specular_D_GGX(in float alpha, in float NdotH) {
