...
namespace driderSDK {
  DR_GRAPHICS_ERROR::E D3DDepthStencil::create(const Device & device, const DrTextureDesc & desc)
  {
    ...
    if (static_cast<const D3DDevice*>(&device)->D3D11Device->CreateDepthStencilView(static_cast<D3DTexture*>(depthTexture.get())->APITexture.Get(), &dDesc, &APIDepthView) != S_OK)
    {
      return DR_GRAPHICS_ERROR::CREATE_RESOURCE_VIEW_ERROR;
    }
    return DR_GRAPHICS_ERROR::ERROR_NONE;
  }
  void D3DDepthStencil::release()
  {
