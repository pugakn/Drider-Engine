...
class DR_API_EXPORT DeviceContext {
 public:
   ...
   virtual void setTextures(UInt32 slot, UInt32 numTextures, Texture* texture) const = 0;
   ...
   virtual void setVertexBuffers(UInt32 slot, UInt32 numBuffers, const VertexBuffer& buffer, UInt32 stride, UInt32 offset) const = 0;
   virtual void setConstantBuffers(UInt32 slot, UInt32 numBuffers, DR_SHADER_TYPE_FLAG::E typeFlag) const = 0;
