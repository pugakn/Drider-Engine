...
driderSDK::Frustrum::createFromVP(const Matrix4x4& ViewProjection)
{
	...
	m_planes[0].m_d = ViewProjection.vector3[3] + ViewProjection.vector3[0];
	...
	m_planes[1].m_d = ViewProjection.vector3[3] - ViewProjection.vector3[0];
	// Top clipping plane    
	...
	m_planes[2].m_d = ViewProjection.vector3[3] - ViewProjection.vector3[1];
	...
	m_planes[5].m_d = ViewProjection.vector3[3] - ViewProjection.vector3[2];
