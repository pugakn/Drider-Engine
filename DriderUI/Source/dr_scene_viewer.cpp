...
namespace driderSDK {
  ...
  void SceneViewer::init(Viewport v)
  {
    m_editorQuad.init();
    m_sceneViewport = v;
  ...
  void SceneViewer::destroy()
  {
    m_renderMan.exit();
  }
  RenderMan& SceneViewer::getRenderManager() 
  {
    return m_renderMan;
  }
  void SceneViewer::initInputs()
  {
  ...
  void SceneViewer::loadResources()
  {
  }
  void SceneViewer::resize(const Viewport& _v)
  {
    Viewport v = Application::getViewPort();
    m_sceneViewport = _v;
    float top = m_sceneViewport.topLeftY / (float)v.height;
    top = top * 2.0 - 1.0;
    top *= -1;
    float left = m_sceneViewport.topLeftX / (float)v.width;
    left = left * 2.0 - 1.0;
    float width = m_sceneViewport.width / (float)v.width;
    width = Math::abs(width * 2.0);
    float height = m_sceneViewport.height / (float)v.height;
  ...
  SceneGraph::SharedGameObject SceneViewer::GetGMOMouseCollition()
  {
